...
class DWDHourlyPrecipitationController extends DWDAbstractHourlyController
{
     ...
     * @return string - path to the file or null
     * @throws Error - Error while logging into the ftp or retrieving the file.
     */
    public function retrieveFile(DWDStation $nearestStation, $forceDownloadFile = false)
    {
        ...
        //complete: /pub/CDC/observations_germany/climate/_hourly/precipitation/recent/stundenwerte_P0_15444
    ...
    {
        $stationsFTPPath = DWDConfiguration::getHourlyConfiguration()->parameters->precipitation->stations;
    ...
    public function parseHourlyData(String $content, DateTime $after = null, DateTime $before = null): array
    {
        ...
        for ($i = sizeof($lines) - 1; $i > 0; $i--) {
            ...
            $date = DateTime::createFromFormat(DWDConfiguration::getHourlyConfiguration()->parserSettings->dateFormat, $cols[1]);
            if ($date) {
                //todo: Schöner...
